...
/// Common base class for [IndexedSet] and [DuplicateKeySet].
abstract class IndexedSetBase<I, E> extends SetMixin<E> {
  IndexedSetBase(this._index, this._comparator, this._filter);

  /// The [index]es of all values in this set.
  Iterable<I> get keys;
...
class IndexedSet<I, E> extends IndexedSetBase<I, E> {
  ...
  @override
  Iterable<I> get keys => _values.keys;
  ...
  IndexedSet.using(
    ...
    bool isValidElement(E element),
      ...
      : _values = base(),
        _valuesFactory = base,
        super(index, areElementsEqual, isValidElement) {
...
///
class DuplicateKeySet<I, E> extends IndexedSetBase<I, E> {
  /// The elements of this set are stored solely as the values of this map.
  final SetMultimap<I, E> _values;
  ...
  DuplicateKeySet(
    ...
    bool areIndexesEqual(I i1, I i2),
      ...
      : this.using(index, () => new SetMultimap<I, E>(equals: areIndexesEqual),
            areElementsEqual: areElementsEqual, isValidElement: isValidElement);
  ...
  ///
  /// Throws an [ArgumentError] if the call to `base` returns a non-empty map.
  DuplicateKeySet.using(
    I Function(E) index,
    SetMultimap<I, E> Function() base, {
    bool areElementsEqual(E e1, E e2),
    bool isValidElement(E element),
  })
      : _values = base(),
